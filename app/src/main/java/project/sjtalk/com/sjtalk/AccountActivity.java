...
//        DatabaseReference ref=firebaseDatabase.getReference("https://sjtalk-9de71.firebaseio.com/");
//
...
//                UserInformation userInformation = dataSnapshot.getValue(UserInformation.class);
//                System.out.println("Name " + userInformation.name);
//                System.out.println("Batch " + userInformation.batch);
//                System.out.println("Branch " + userInformation.branch);
...
//      View view=navigationView.inflateHeaderView(R.layout.nav_header_account);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_editProfile) {
            // Handle the Edit Profile Option
